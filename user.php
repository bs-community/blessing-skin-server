	...
	<nav class="navbar navbar-default">
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse">
				...
				<li><a>Welcome, <?php echo $_COOKIE["uname"]; ?>!</a></li>
...
<?php
// 前端不好判断，后端判断文件是否存在
$skinFile = "./uploads/skin/".$_COOKIE['uname'].".png";
if (file_exists($skinFile)) {
    echo "<script>var dskin ='".$skinFile."';</script>";
} else {
...
$capeFile = "./uploads/cape/".$_COOKIE['uname'].".png";
if (file_exists($capeFile)) {
    echo "<script>var dcape ='".$capeFile."';</script>";
}
