            ...
            <div class="col-md-8">
                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title" title="切换分类" data-toggle="tooltip" data-placement="bottom">
                            <a href="?category=skin" {{ ($category == "skin") ? 'class=selected' : "" }}>皮肤</a>
                            /
                            <a href="?category=cape" {{ ($category == "cape") ? 'class=selected' : "" }}>披风</a>
                        </h3>
                    </div><!-- /.box-header -->
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">要给哪个角色使用呢？</h4>
            </div>
