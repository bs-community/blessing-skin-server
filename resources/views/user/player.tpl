                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr class="player" id="{{ $player['pid'] }}">
                                    ...
                                    <td>
                                        <a class="btn btn-default btn-sm" href="javascript:changePlayerMame('{{ $player['pid'] }}', '{{ $player['player_name'] }}')">修改角色名</a>
                                    </td>
                                    <td>
                                        <a class="btn btn-warning btn-sm" href="javascript:clearTexture('{{ $player['pid'] }}');">删除材质</a>
            ...
            <div class="col-md-6">
                <div class="box">
                    ...
                    <div class="box-body">
                        <div id="skinpreview">
                            <div id="preview-2d">
                                <p>Steve 模型的皮肤：<a href=""><img id="steve" class="skin2d" /></a>
                                    <span class="skin2d">未上传</span>
                                </p>

                                <p>Alex 模型的皮肤：<a href=""><img id="alex" class="skin2d" /></a>
                                    <span class="skin2d">未上传</span>
                                </p>

                                <p>披风：<a href=""><img id="cape" class="skin2d" /></a>
                                    <span class="skin2d">未上传</span>
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="box-footer">
                        <button id="preview-switch" onclick="show2dPreview()" class="btn btn-default">切换 2D 预览</button>
                    </div>
                </div><!-- /.box -->
            </div>
        </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
                        ...
                        <tr>
                            ...
                            <td>
                               <input type="text" class="form-control" id="player_name"
                                    placeholder="{{ (Option::get('allow_chinese_playername') == '1') ? '可使用汉字，字母数字以及下划线' : '只能包含数字、字母以及下划线' }}" value="">
                            </td>
                        </tr>
                    </tbody>
                </table>
            ...
            <div class="modal-footer">
                ...
                <a href="javascript:addNewPlayer();" class="btn btn-primary">提交</a>
            </div>
        </div><!-- /.modal-content -->
    </div><!-- /.modal-dialog -->
</div><!-- /.modal -->
